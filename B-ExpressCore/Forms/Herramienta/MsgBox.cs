...
namespace Express
{
    public partial class MsgBox : Form
    {
        ...
        public MsgBox(string msg, string alertType)
        {
            InitializeComponent();
            ...
            if (alertType == "err") { pictureBox1.Image = Express.Properties.Resources.msg_error; MessageBoxCaption.Text = "Error"; System.Media.SystemSounds.Beep.Play(); }
            else if (alertType == "info") { pictureBox1.Image = Express.Properties.Resources.msg_info; MessageBoxCaption.Text = "Information"; System.Media.SystemSounds.Asterisk.Play(); }
            else if (alertType == "que") { pictureBox1.Image = Express.Properties.Resources.msg_ques; MessageBoxCaption.Text = "Question"; System.Media.SystemSounds.Question.Play(); }
            else if (alertType == "exc") { pictureBox1.Image = Express.Properties.Resources.msg_exc; MessageBoxCaption.Text = "Exclamation"; System.Media.SystemSounds.Exclamation.Play(); }
            else { pictureBox1.Image = Express.Properties.Resources.msg_info; MessageBoxCaption.Text = "Information"; System.Media.SystemSounds.Asterisk.Play(); }
        }
