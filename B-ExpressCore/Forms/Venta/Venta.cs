...
namespace Express
{
    public partial class Venta : Form
    {
        ...
        private void btnOptions_Click(object sender, EventArgs e)
        {
            ...
            DetalleEnvio frmShippingDetails = new DetalleEnvio(txtInvoiceNo.Text);
        ...
        private void btnPrintView_Click(object sender, EventArgs e)
        {
            ...
            {
                ///////////////////////////////////////////
                ImprimirFactura frmInvoicePrint = new ImprimirFactura(txtInvoiceNo.Text, "QuickSale");
