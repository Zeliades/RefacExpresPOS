...
namespace Express
{
    public partial class Cliente : Form
    {
        ...
        {
            string DestPath = Application.StartupPath + @"\Upload\Cliente\";
        ...
        private void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            try {
                pictureBox1.ImageLocation = Application.StartupPath + @"\Upload\Cliente\" + dataGridView1.Rows[e.RowIndex].Cells["Column8"].Value.ToString() ;
