...
namespace Express
{
    ...
    public partial class Proveedor : Form
    {
        ...
        {
            string DestPath = Application.StartupPath + @"\Upload\Proveedor\";
        ...
        private void btnReset_Click(object sender, EventArgs e)
        {
            ...
            pictureBox1.Image = Express.Properties.Resources.Imagen;
            LoadData();
        }
        ...
        private void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            try
            {
                pictureBox1.ImageLocation = Application.StartupPath + @"\Upload\Proveedor\" + dataGridView1.Rows[e.RowIndex].Cells["Column8"].Value.ToString();
            ...
            catch (Exception) { pictureBox1.Image = Express.Properties.Resources.Imagen; }
