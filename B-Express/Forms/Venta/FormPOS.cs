...
namespace Express
{
    ...
    {
        public FormPOS(String SALES_ID)
        {
            InitializeComponent();
        ...
        private void LoadGroupPanel()
        {
            ...
            if (clsUtility.sqlDT.Rows.Count > 0)
            {
                ...
                for (i = 0; i <= clsUtility.sqlDT.Rows.Count - 1; i++)
                {
                    ...
                    grpButton.Image = Express.Properties.Resources.Compra1;
        ...
        private void LoadProductPanel(string GROUP_ID)
        {
            ...
            if (clsUtility.sqlDT.Rows.Count > 0)
            {
                ...
                for (i = 0; i <= clsUtility.sqlDT.Rows.Count - 1; i++)
                {
                    ...
                    catch (Exception) { picturebx.Image = resizeImage(Express.Properties.Resources.Imagen, new Size(74, 71)); }
        ...
        private void btnReceipt_Click(object sender, EventArgs e)
        {
            ...
            if (clsUtility.sqlDT.Rows.Count > 0)
            {
                ...
                ImprimirFactura frmInvoicePrint = new ImprimirFactura(txtInvoiceNo.Text, "POS");
        ...
        {
            ClienteVisor frmCustomerDisplay = new ClienteVisor();
        ...
        private void btnCustomerList_Click(object sender, EventArgs e)
        {
            ...
            Cliente frmCustomerInfo = Application.OpenForms["frmCustomerInfo"] as Cliente;
