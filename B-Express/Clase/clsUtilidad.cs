...
//=======================================================
//Developed by: Ing. Héctor Daniel Di Stasi 
//Linkedin    : https://www.linkedin.com/in/hdistasi/
//Facebook    : https://www.facebook.com/hectordaniel.distasi.37 
//Email       : hdistasi@gmail.com
//Database    : SQLite
...
namespace Express
{
    class clsUtility
    {
        ...
        public static void GetCompanyDetails_ReportsParameters()
        {
            ...
            {
                crpCompanyName.Value = "Empresa";
                crpAddress.Value = "Domicilio";
                crpTelephone.Value = "Teléfono";
                crpEmail.Value = "Email";
                crpWEB.Value = "Web";
                crpSlogan.Value = "Slogan...";
            }
        }
        //Your Company Name
        ...
        public static void Preview__SalesReceipt(string sql, CrystalReportViewer CrystalReportViewer)
        {
            ...
            AppStartDirectory.Value = Application.StartupPath + @"\Upload\Empresa\BrandLogo.jpg";
        ...
        public static void Preview__EmployeeList(string sql, CrystalReportViewer CrystalReportViewer)
        {
            ...
            AppStartDirectory.Value = Application.StartupPath + @"\Upload\Empleado\";
            ParamCollection.Add(AppStartDirectory);
            rpt_Document.ParameterFields["AppStartDirectory"].CurrentValues = ParamCollection;
            CrystalReportViewer.ReportSource = rpt_Document;
        }
